  ...
  partial struct ExtendedGamePadState {
    ...
    public ExtendedGamePadState(
      ...
      // Take over the joystick's axes
      {
        ...
        IAxisReader[] axisReaders = converter.AxisReaders;

        if (axisReaders[0] != null) {
          this.X = axisReaders[0].GetValue(joystickState);
        } else {
          this.X = 0.0f;
        }
        if (axisReaders[1] != null) {
          this.Y = -axisReaders[1].GetValue(joystickState);
        } else {
          this.Y = 0.0f;
        }
        if (axisReaders[2] != null) {
          this.Z = axisReaders[2].GetValue(joystickState);
        } else {
          this.Z = 0.0f;
        }

        if (axisReaders[3] != null) {
          this.VelocityX = axisReaders[3].GetValue(joystickState);
        } else {
          this.VelocityX = 0.0f;
        }
        if (axisReaders[4] != null) {
          this.VelocityY = -axisReaders[4].GetValue(joystickState);
        } else {
          this.VelocityY = 0.0f;
        }
        if (axisReaders[5] != null) {
          this.VelocityZ = axisReaders[5].GetValue(joystickState);
        } else {
          this.VelocityZ = 0.0f;
        }

        if (axisReaders[6] != null) {
          this.AccelerationX = axisReaders[6].GetValue(joystickState);
        } else {
          this.AccelerationX = 0.0f;
        }
        if (axisReaders[7] != null) {
          this.AccelerationY = -axisReaders[7].GetValue(joystickState);
        } else {
          this.AccelerationY = 0.0f;
        }
        if (axisReaders[8] != null) {
          this.AccelerationZ = axisReaders[8].GetValue(joystickState);
        } else {
          this.AccelerationZ = 0.0f;
        }

        if (axisReaders[9] != null) {
          this.ForceX = axisReaders[9].GetValue(joystickState);
        } else {
          this.ForceX = 0.0f;
        }
        if (axisReaders[10] != null) {
          this.ForceY = -axisReaders[10].GetValue(joystickState);
        } else {
          this.ForceY = 0.0f;
        }
        if (axisReaders[11] != null) {
          this.ForceZ = axisReaders[11].GetValue(joystickState);
        } else {
          this.ForceZ = 0.0f;
        }

        if (axisReaders[12] != null) {
          this.RotationX = axisReaders[12].GetValue(joystickState);
        } else {
          this.RotationX = 0.0f;
        }
        if (axisReaders[13] != null) {
          this.RotationY = -axisReaders[13].GetValue(joystickState);
        } else {
          this.RotationY = 0.0f;
        }
        if (axisReaders[14] != null) {
          this.RotationZ = axisReaders[14].GetValue(joystickState);
        } else {
          this.RotationZ = 0.0f;
        }

        if (axisReaders[15] != null) {
          this.AngularVelocityX = axisReaders[15].GetValue(joystickState);
        } else {
          this.AngularVelocityX = 0.0f;
        }
        if (axisReaders[16] != null) {
          this.AngularVelocityY = -axisReaders[16].GetValue(joystickState);
        } else {
          this.AngularVelocityY = 0.0f;
        }
        if (axisReaders[17] != null) {
          this.AngularVelocityZ = axisReaders[17].GetValue(joystickState);
        } else {
          this.AngularVelocityZ = 0.0f;
        }

        if (axisReaders[18] != null) {
          this.AngularAccelerationX = axisReaders[18].GetValue(joystickState);
        } else {
          this.AngularAccelerationX = 0.0f;
        }
        if (axisReaders[19] != null) {
          this.AngularAccelerationY = -axisReaders[19].GetValue(joystickState);
        } else {
          this.AngularAccelerationY = 0.0f;
        }
        if (axisReaders[20] != null) {
          this.AngularAccelerationZ = axisReaders[20].GetValue(joystickState);
        } else {
          this.AngularAccelerationZ = 0.0f;
        }

        if (axisReaders[21] != null) {
          this.TorqueX = axisReaders[21].GetValue(joystickState);
        } else {
          this.TorqueX = 0.0f;
        }
        if (axisReaders[22] != null) {
          this.TorqueY = -axisReaders[22].GetValue(joystickState);
        } else {
          this.TorqueY = 0.0f;
        }
        if (axisReaders[23] != null) {
          this.TorqueZ = axisReaders[23].GetValue(joystickState);
        } else {
          this.TorqueZ = 0.0f;
        }
      }
      ...
      // Take over the joystick's sliders
      {
        ...
        ISliderReader[] sliderReaders = converter.SliderReaders;

        if (sliderReaders[0] != null) {
          this.Slider1 = sliderReaders[0].GetValue(joystickState);
        } else {
          this.Slider1 = 0.0f;
        }
        if (sliderReaders[1] != null) {
          this.Slider2 = sliderReaders[1].GetValue(joystickState);
        } else {
          this.Slider2 = 0.0f;
        }

        if (sliderReaders[2] != null) {
          this.VelocitySlider1 = sliderReaders[2].GetValue(joystickState);
        } else {
          this.VelocitySlider1 = 0.0f;
        }
        if (sliderReaders[3] != null) {
          this.VelocitySlider2 = sliderReaders[3].GetValue(joystickState);
        } else {
          this.VelocitySlider2 = 0.0f;
        }

        if (sliderReaders[4] != null) {
          this.AccelerationSlider1 = sliderReaders[4].GetValue(joystickState);
        } else {
          this.AccelerationSlider1 = 0.0f;
        }
        if (sliderReaders[5] != null) {
          this.AccelerationSlider2 = sliderReaders[5].GetValue(joystickState);
        } else {
          this.AccelerationSlider2 = 0.0f;
        }

        if (sliderReaders[6] != null) {
          this.ForceSlider1 = sliderReaders[6].GetValue(joystickState);
        } else {
          this.ForceSlider1 = 0.0f;
        }
        if (sliderReaders[7] != null) {
          this.ForceSlider2 = sliderReaders[7].GetValue(joystickState);
        } else {
