...
//    ///   </para>
//    /// </remarks>
//    public partial class ParticleSystem<ParticleType> : IDisposable, IParticleSystem<ParticleType> where ParticleType : struct
//    {
...
//            if (this.noncoalescableAffectors.Count > 1)
//            { // multiple non-coalescables?
...
//            }
//            else if (this.noncoalescableAffectors.Count == 1)
//            { // only one non-coalescable
