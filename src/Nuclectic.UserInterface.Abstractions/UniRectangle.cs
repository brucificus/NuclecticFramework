...
namespace Nuclectic.UserInterface
{
	...
	public struct UniRectangle
	{
		...
		public UniScalar Left { get { return this.Location.X; } set { this.Location.X = value; } }

		/// <summary>Y coordinate of the rectangle's upper border</summary>
		public UniScalar Top { get { return this.Location.Y; } set { this.Location.Y = value; } }

		/// <summary>X coordinate of the rectangle's right border</summary>
		public UniScalar Right { get { return this.Location.X + this.Size.X; } set { this.Size.X = value - this.Location.X; } }

		/// <summary>Y coordinate of the rectangle's lower border</summary>
		public UniScalar Bottom { get { return this.Location.Y + this.Size.Y; } set { this.Size.Y = value - this.Location.Y; } }
		...
		public static bool operator !=(UniRectangle first, UniRectangle second) { return !(first == second); }
