...
namespace Nuclectic.UserInterface.Controls
{
	...
	public partial class Control : IHasScreen, IHasSettableScreen, ICommandProcessor
	{
		...
		public IScreen Screen { get { return this.screen; } }
		...
		protected internal Control MouseOverControl { get { return this.mouseOverControl; } }

		/// <summary>Control that currently captured incoming input</summary>
		protected internal Control ActivatedControl { get { return this.activatedControl; } }
