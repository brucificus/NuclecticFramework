...
namespace Nuclectic.Fonts
{
	...
	public class VectorFontCharacter : IVectorFontCharacter
	{
		...
		public Vector2 Advancement { get { return this.advancement; } }
		...
		/// </remarks>
		public IReadOnlyList<Vector2> Vertices { get { return this.vertices; } }
		...
		///     </para>
		/// </remarks>
		public IReadOnlyList<Outline> Outlines { get { return this.outlines; } }

		/// <summary>
		///     Specifies between which vertices triangles have to be drawn to draw a
		///     polygon-filled character.
		/// </summary>
		public IReadOnlyList<Face> Faces { get { return this.faces; } }
