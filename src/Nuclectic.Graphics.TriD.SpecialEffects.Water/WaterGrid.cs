...
namespace Nuclectic.Graphics.TriD.SpecialEffects.Water
{
	...
	public class WaterGrid : StaticMesh<WaterVertex>
	{
		...
		public int VertexCount { get { return this.vertexCount; } }

		/// <summary>Number of indices required to draw the grid</summary>
		public int IndexCount { get { return this.indexCount; } }

		/// <summary>Number of primitives that need to be drawn for the grid</summary>
		public int PrimitiveCount { get { return this.indexCount - 2; } }

		/// <summary>The type of primitive used to render the grid</summary>
		public PrimitiveType PrimitiveType { get { return PrimitiveType.TriangleStrip; } }

		/// <summary>Vertex buffer containing the vertices making up the plane</summary>
		public new VertexBuffer VertexBuffer { get { return this.vertexBuffer; } }
