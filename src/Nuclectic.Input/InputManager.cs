...
namespace Nuclectic.Input
{
		...
		IDisposable
	{
		...
		public InputManager(
			IDirectInputManager directInputManager, IKeyboardSoloFactory keyboardSoloFactory, IMouseFactory mouseFactory, GameServiceContainer services = null)
		{
		...
		public ReadOnlyCollection<IKeyboard> Keyboards { get { return this.keyboards; } }

		/// <summary>All mice known to the system</summary>
		public ReadOnlyCollection<IMouse> Mice { get { return this.mice; } }

		/// <summary>All game pads known to the system</summary>
		public ReadOnlyCollection<IGamePad> GamePads { get { return this.gamePads; } }

		/// <summary>All touch panels known to the system</summary>
		public ReadOnlyCollection<ITouchPanel> TouchPanels { get { return this.touchPanels; } }
