...
namespace Nuclectic.Input.Devices
{
	...
	internal class XnaGamePad : GamePad
	{
		...
		public override GamePadState GetState() { return this.current; }
		...
		public override IExtendedGamePadState GetExtendedState() { return new ExtendedGamePadState(ref this.current); }

		/// <summary>Whether the input device is connected to the system</summary>
		public override bool IsAttached { get { return this.current.IsConnected; } }

		/// <summary>Human-readable name of the input device</summary>
		public override string Name { get { return "Xbox 360 game pad #" + ((int)this.playerIndex + 1).ToString(); } }
		...
		///     to the user.
		/// </remarks>
		public override void TakeSnapshot() { this.states.Enqueue(MsGamePad.GetState(this.playerIndex)); }
