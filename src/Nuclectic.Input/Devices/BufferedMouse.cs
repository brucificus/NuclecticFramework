...
namespace Nuclectic.Input.Devices
{
	...
	public abstract class BufferedMouse : IMouse
	{
		...
		public BufferedMouse() { this.queuedEvents = new Queue<MouseEvent>(); }
		...
		///     to the user.
		/// </remarks>
		public void TakeSnapshot() { this.queuedEvents.Enqueue(MouseEvent.Snapshot()); }
		...
		/// <summary>Records a mouse button press in the event queue</summary>
		/// <param name="buttons">Buttons that have been pressed</param>
		protected void BufferButtonPress(MouseButtons buttons) { this.queuedEvents.Enqueue(MouseEvent.ButtonPress(buttons)); }

		/// <summary>Records a mouse button release in the event queue</summary>
		/// <param name="buttons">Buttons that have been released</param>
		protected void BufferButtonRelease(MouseButtons buttons) { this.queuedEvents.Enqueue(MouseEvent.ButtonRelease(buttons)); }

		/// <summary>Records a mouse wheel rotation in the event queue</summary>
		/// <param name="ticks">Ticks the mouse wheel has been rotated</param>
		protected void BufferWheelRotation(float ticks) { this.queuedEvents.Enqueue(MouseEvent.WheelRotation(ticks)); }

		/// <summary>Records a mouse cursor movement in the event queue</summary>
		/// <param name="x">X coordinate the mouse cursor has been moved to</param>
		/// <param name="y">Y coordinate the mouse cursor has been moved to</param>
		protected void BufferCursorMovement(float x, float y) { this.queuedEvents.Enqueue(MouseEvent.Movement(x, y)); }
