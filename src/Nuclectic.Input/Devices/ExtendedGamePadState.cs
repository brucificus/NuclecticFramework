...
namespace Nuclectic.Input.Devices
{
	...
	public partial struct ExtendedGamePadState : IExtendedGamePadState
	{
		...
		public int AxisCount { get { return countBits((uint)this.AvailableAxes); } }
		...
		public int SliderCount { get { return countBits((uint)this.AvailableSliders); } }
