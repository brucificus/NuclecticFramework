...
namespace Nuclectic.Input.Devices
{
	...
	public abstract class GamePad : IGamePad
	{
		...
		public abstract IExtendedGamePadState GetExtendedState();
		...
		protected bool HaveEventSubscribers { get { return (ButtonPressed != null) || (ButtonReleased != null); } }

		/// <summary>Whether subscribers to the extended button events exist</summary>
		protected bool HaveExtendedEventSubscribers { get { return (ExtendedButtonPressed != null) || (ExtendedButtonReleased != null); } }
