...
namespace Nuclectic.Input.Devices
{
	...
	public abstract class BufferedKeyboard : IKeyboard
	{
		...
		public KeyboardState GetState() { return this.current; }
		...
		///     to the user.
		/// </remarks>
		public void TakeSnapshot() { this.queuedEvents.Enqueue(KeyboardEvent.Snapshot()); }
		...
		/// <summary>Records a key press in the event queue</summary>
		/// <param name="key">Key that has been pressed</param>
		protected void BufferKeyPress(Keys key) { this.queuedEvents.Enqueue(KeyboardEvent.KeyPress(key)); }

		/// <summary>Records a key release in the event queue</summary>
		/// <param name="key">Key that has been released</param>
		protected void BufferKeyRelease(Keys key) { this.queuedEvents.Enqueue(KeyboardEvent.KeyRelease(key)); }

		/// <summary>Records a character in the event queue</summary>
		/// <param name="character">Character that has been entered</param>
		protected void BufferCharacterEntry(char character) { this.queuedEvents.Enqueue(KeyboardEvent.CharacterEntry(character)); }
