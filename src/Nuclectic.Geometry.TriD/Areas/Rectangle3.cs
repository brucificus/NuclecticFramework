...
namespace Nuclectic.Geometry.Areas
{
	...
	public class Rectangle3 : IArea3
	{
		...
		public float Area { get { throw new NotImplementedException("Not implemented yet"); } }

		/// <summary>The total length of the area's circumference</summary>
		public float CircumferenceLength { get { throw new NotImplementedException("Not implemented yet"); } }

		/// <summary>The center of mass within the shape</summary>
		public Vector3 CenterOfMass { get { throw new NotImplementedException("Not implemented yet"); } }

		/// <summary>Smallest rectangle that encloses the shape in its entirety</summary>
		public Volumes.AxisAlignedBox3 BoundingBox { get { throw new NotImplementedException("Not implemented yet"); } }
		...
		public Vector3 ClosestPointTo(Vector3 location) { throw new NotImplementedException("Not implemented yet"); }
		...
		public Vector3 RandomPointOnPerimeter(IRandom randomNumberGenerator) { throw new NotImplementedException("Not implemented yet"); }

		/// <summary>Returns a random point inside the area</summary>
		/// <param name="randomNumberGenerator">Random number generator that will be used</param>
		/// <returns>A random point inside the area</returns>
		public Vector3 RandomPointWithin(IRandom randomNumberGenerator) { throw new NotImplementedException("Not implemented yet"); }
	}
