...
namespace Nuclectic.Geometry.Areas
{
	...
	public class Disc3 : IArea3
	{
		...
		public float Area { get { return MathHelper.Pi * (this.Radius * this.Radius); } }

		/// <summary>The total length of the area's circumference</summary>
		public float CircumferenceLength { get { return 2.0f * MathHelper.Pi * this.Radius; } }

		/// <summary>The center of mass within the shape</summary>
		public Vector3 CenterOfMass { get { return this.Transform.Translation; } }
