...
namespace Nuclectic.Geometry.Areas
{
	...
	public class Plane3 : IArea3
	{
		...
		/// <param name="normal">Vector that is exactly perpendicular to the plane</param>
		[DebuggerStepThrough]
		public Plane3(float distance, Vector3 normal)
		...
		public float Area { get { return float.PositiveInfinity; } }

		/// <summary>The total length of the area's circumference</summary>
		public float CircumferenceLength { get { return float.PositiveInfinity; } }

		/// <summary>The center of mass within the shape</summary>
		public Vector3 CenterOfMass { get { return this.Offset; } }
		...
		{
			Vector3 planePoint = Plane3PointGenerator.RandomPointOnPerimeter(
		...
		{
			Vector3 planePoint = Plane3PointGenerator.RandomPointWithin(
																	    randomNumberGenerator,
																		this.Normal
				);
