...
namespace Nuclectic.Geometry.Lines
{
	...
	public class Line3 : ILine3
	{
		...
		public static bool operator !=(Line3 first, Line3 second) { return !(first == second); }
		...
		public override bool Equals(object other) { return Equals(other as Line3); }
		...
		public override int GetHashCode() { unchecked { return Offset.GetHashCode() + Direction.GetHashCode(); } }
		...
		{
			return Line3Sphere3Collider.FindContacts(
		...
		{
			return Line3Aabb3Collider.FindContacts(
		...
		{
			return Line3Triangle3Collider.FindContacts(
		...
		{
			return Line3Plane3Collider.FindContacts(
