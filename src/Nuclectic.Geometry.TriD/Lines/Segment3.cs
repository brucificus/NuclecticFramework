...
namespace Nuclectic.Geometry.Lines
{
	...
	public class Segment3 : ILine3
	{
		...
		public float Length { get { return (this.End - this.Start).Length(); } }
		...
		public static bool operator !=(Segment3 first, Segment3 second) { return !(first == second); }
		...
		public override bool Equals(object other) { return Equals(other as Segment3); }
		...
		public override int GetHashCode() { unchecked { return Start.GetHashCode() + End.GetHashCode(); } }
