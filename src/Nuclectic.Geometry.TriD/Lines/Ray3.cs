...
namespace Nuclectic.Geometry.Lines
{
	...
	public class Ray3 : ILine3
	{
		...
		public static bool operator !=(Ray3 first, Ray3 second) { return !(first == second); }
		...
		public override bool Equals(object other) { return Equals(other as Ray3); }
		...
		public override int GetHashCode() { unchecked { return Origin.GetHashCode() + Direction.GetHashCode(); } }
		...
		{
			return Ray3Sphere3Collider.FindContacts(
		...
		{
			return Ray3Aabb3Collider.FindContacts(
