...
using Nuclectic.Geometry.Areas.PointGenerators;
...
namespace Nuclectic.Geometry.Volumes
{
	...
	public class TriangleMesh3 : IVolume3
	{
		...
		public float SurfaceArea { get { return this.surfaceArea; } }

		/// <summary>Center of the volume's mass</summary>
		public Vector3 CenterOfMass { get { return this.centerOfMass; } }

		/// <summary>The inetria tensor matrix of the volume</summary>
		public Matrix InertiaTensor { get { return this.inertiaTensor; } }
		...
		public Vector3 ClosestPointTo(Vector3 location) { throw new Exception("The method or operation is not implemented."); }
		...
		public Vector3 RandomPointOnSurface(IRandom randomNumberGenerator)
		{
			...
			return Triangle3PointGenerator.GenerateRandomPointWithin(
		...
		public Vector3 RandomPointWithin(IRandom randomNumberGenerator) { throw new Exception("The method or operation is not implemented."); }
