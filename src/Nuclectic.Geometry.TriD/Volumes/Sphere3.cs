...
namespace Nuclectic.Geometry.Volumes
{
	...
	public class Sphere3 : IVolume3
	{
		...
		public float Mass { get { return 4.0f / 3.0f * MathHelper.Pi * (this.Radius * this.Radius * this.Radius); } }

		/// <summary>The volume's total surface area</summary>
		public float SurfaceArea { get { return 4.0f * MathHelper.Pi * (this.Radius * this.Radius); } }

		/// <summary>Center of the volume's mass</summary>
		public Vector3 CenterOfMass { get { return Center; } }
		...
		public static bool operator ==(Sphere3 first, Sphere3 second) { return (first.Center == second.Center) && (first.Radius == second.Radius); }
		...
		public override string ToString() { return "{ " + Center.ToString() + " R:" + Radius + " }"; }
