...
namespace Nuclectic.Geometry.Volumes
{
	...
	public class Box3 : IVolume3
	{
		...
		public float Mass { get { return Dimensions.X * Dimensions.Y * Dimensions.Z; } }
		...
		public Vector3 Dimensions { get { return Extents * 2.0f; } }
		...
		public override int GetHashCode() { return Transform.GetHashCode() ^ Center.GetHashCode() ^ Extents.GetHashCode(); }
