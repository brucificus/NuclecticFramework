...
namespace Nuclectic.Geometry.Volumes
{
	...
	public class AxisAlignedBox3 : IVolume3
	{
		...
		public void Accept(VolumeVisitor visitor) { visitor.Visit(this); }
		...
		public float Mass { get { return Width * Height * Depth; } }
		...
		public float Width
		{
			[System.Diagnostics.DebuggerStepThrough] get { return Max.X - Min.X; }
		}

		/// <summary>The height of the box (y axis)</summary>
		public float Height
		{
			[System.Diagnostics.DebuggerStepThrough] get { return Max.Y - Min.Y; }
		}

		/// <summary>The depth of the box (z axis)</summary>
		public float Depth
		{
			[System.Diagnostics.DebuggerStepThrough] get { return Max.Z - Min.Z; }
		}

		/// <summary>Vector containing the extents of the box</summary>
		public Vector3 Extents
		{
			[System.Diagnostics.DebuggerStepThrough] get { return this.Dimensions / 2.0f; }
		}

		/// <summary>Vector containing the dimensions of the box</summary>
		public Vector3 Dimensions
		{
			[System.Diagnostics.DebuggerStepThrough] get { return Max - Min; }
		}

		/// <summary>The center of the box</summary>
		public Vector3 Center
		{
			[System.Diagnostics.DebuggerStepThrough] get { return (Min + Max) / 2; }
		}
		...
		[System.Diagnostics.DebuggerStepThrough]
		public static bool operator ==(AxisAlignedBox3 first, AxisAlignedBox3 second) { return (first.Min == second.Min) && (first.Max == second.Max); }
