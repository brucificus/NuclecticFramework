...
namespace Nuclectic.Geometry.Volumes
{
	...
	public class Cylinder3 : IVolume3
	{
		...
		public Vector3 CenterOfMass { get { return this.Center; } }
		...
		public bool Intersects(Sphere3 sphere) { throw new NotImplementedException("Not implemented yet"); }
		...
		/// <returns>True if the objects overlap</returns>
		public bool Intersects(AxisAlignedBox3 box) { throw new NotImplementedException("Not implemented yet"); }

		/// <summary>Determines if the volume clips the box</summary>
		/// <param name="box">Box that will be checked for intersection</param>
		/// <returns>True if the objects overlap</returns>
		public bool Intersects(Box3 box) { throw new NotImplementedException("Not implemented yet"); }
		...
		public Vector3 Center { get { return this.Transform.Translation; } set { this.Transform.Translation = value; } }
