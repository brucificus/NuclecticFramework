...
namespace Nuclectic.Graphics.Helpers
{
	...
	public sealed class VertexElementAttribute : Attribute
	{
		...
		public VertexElementAttribute(VertexElementUsage usage) { this.usage = usage; }
		...
		public VertexElementUsage Usage { get { return this.usage; } }

		/// <summary>Format the vertex element's data is provided in</summary>
		public VertexElementFormat Format { get { return this.format; } }

		/// <summary>Index of the element when multiple elements share the same usage</summary>
		public byte UsageIndex { get { return this.usageIndex; } set { this.usageIndex = value; } }

		/// <summary>True if a format has been provided for the vertex element</summary>
		public bool FormatProvided { get { return this.formatProvided; } }
