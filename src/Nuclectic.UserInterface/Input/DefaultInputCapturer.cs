...
namespace Nuclectic.UserInterface.Input
{
	...
	public class DefaultInputCapturer : IInputCapturer, IDisposable
	{
		...
		private void buttonReleased(Buttons buttons) { this.inputReceiver.InjectButtonRelease(buttons); }
		...
		private void mouseWheelRotated(float ticks) { this.inputReceiver.InjectMouseWheel(ticks); }
		...
		private void mouseMoved(float x, float y) { this.inputReceiver.InjectMouseMove(x, y); }

		/// <summary>Called when a mouse button has been released</summary>
		/// <param name="buttons">Mouse button that has been released</param>
		private void mouseButtonReleased(MouseButtons buttons) { this.inputReceiver.InjectMouseRelease(buttons); }

		/// <summary>Called when a mouse button has been pressed</summary>
		/// <param name="buttons">Mouse button that has been pressed</param>
		private void mouseButtonPressed(MouseButtons buttons) { this.inputReceiver.InjectMousePress(buttons); }

		/// <summary>Called when a character has been entered on the keyboard</summary>
		/// <param name="character">Character that has been entered</param>
		private void characterEntered(char character) { this.inputReceiver.InjectCharacter(character); }

		/// <summary>Called when a key has been released</summary>
		/// <param name="key">Key that was released</param>
		private void keyReleased(Keys key) { this.inputReceiver.InjectKeyRelease(key); }

		/// <summary>Called when a key has been pressed</summary>
		/// <param name="key">Key that was pressed</param>
		private void keyPressed(Keys key) { this.inputReceiver.InjectKeyPress(key); }
