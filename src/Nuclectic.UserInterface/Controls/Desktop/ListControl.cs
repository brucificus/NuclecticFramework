...
namespace Nuclectic.UserInterface.Controls.Desktop
{
	...
	public class ListControl : Control, IFocusable
	{
		...
		public ListSelectionMode SelectionMode { get { return this.selectionMode; } set { this.selectionMode = value; } }

		/// <summary>Slider the list uses to scroll through its items</summary>
		public VerticalSliderControl Slider { get { return this.slider; } }

		/// <summary>Items being displayed in the list</summary>
		public IList<string> Items { get { return this.items; } }

		/// <summary>Indices of the items current selected in the list</summary>
		public IList<int> SelectedItems { get { return this.selectedItems; } }
		...
		protected override void OnMouseMoved(float x, float y) { this.mouseY = y; }
		...
		bool IFocusable.CanGetFocus { get { return true; } }
		...
		private void itemRemoved(object sender, ItemEventArgs<string> arguments) { updateSlider(); }
		...
		private void itemAdded(object sender, ItemEventArgs<string> arguments) { updateSlider(); }
		...
		private void itemsCleared(object sender, EventArgs arguments) { updateSlider(); }
		...
		private void selectionRemoved(object sender, ItemEventArgs<int> arguments) { OnSelectionChanged(); }
		...
		/// <param name="arguments">Not Used</param>
		private void selectionCleared(object sender, EventArgs arguments) { OnSelectionChanged(); }

		/// <summary>Updates the size and position of the list's slider</summary>
		private void updateSlider()
		{
			if ((Screen != null)
				&& (this.listRowLocator != null))
			{
				RectangleF bounds = GetAbsoluteBounds();
