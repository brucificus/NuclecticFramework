...
namespace Nuclectic.Input.Devices
{
	...
	public partial class DirectInputConverter : IDirectInputConverter
	{
		...
		public DirectInputConverter(Joystick joystick)
		{
		...
		public ExtendedAxes AvailableAxes { get { return this.availableAxes; } }

		/// <summary>Bit mask of the sliders available on the joystick</summary>
		public ExtendedSliders AvailableSliders { get { return this.availableSliders; } }

		/// <summary>Readers for the sliders in the order of the enumeration</summary>
		public ISliderReader[] SliderReaders { get { return this.sliderReaders; } }

		/// <summary>Readers for the axes in the order of the enumeration</summary>
		public IAxisReader[] AxisReaders { get { return this.axisReaders; } }

		/// <summary>Number of buttons on the device</summary>
		public int ButtonCount { get { return this.buttonCount; } }

		/// <summary>Number of PoV controllers on the device</summary>
		public int PovCount { get { return this.povCount; } }
