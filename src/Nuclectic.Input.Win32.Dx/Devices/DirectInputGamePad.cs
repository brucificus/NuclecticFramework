...
namespace Nuclectic.Input.Devices
{
	...
	internal class DirectInputGamePad : GamePad, IDisposable
	{
		...
		public override GamePadState GetState() { return this.converter.Convert(new JoystickStateAdapter(this.states.Items[this.states.HeadIndex])); }
		...
		public override bool IsAttached { get { return this.checkAttachedDelegate(this.joystick); } }

		/// <summary>Human-readable name of the input device</summary>
		public override string Name { get { return this.joystick.Information.InstanceName; } }
