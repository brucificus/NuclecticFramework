...
namespace Nuclectic.Input.Devices
{
	...
	internal class LeakyQueue<ItemType>
	{
		...
		public LeakyQueue() { this.items = LeakyQueue<ItemType>.emptyArray; }
		...
		public int HeadIndex { get { return this.headIndex; } }

		/// <summary>Index one past the last item in the queue</summary>
		public int TailIndex { get { return this.tailIndex; } }

		/// <summary>Returns the internal item array of the queue</summary>
		public ItemType[] Items { get { return this.items; } }
