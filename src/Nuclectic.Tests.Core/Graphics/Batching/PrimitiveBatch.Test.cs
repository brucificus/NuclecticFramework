...
//		this.primitiveBatch = new PrimitiveBatch<VertexDeclarationHelperTest.TestVertex>(
...
//	  public PrimitiveBatch<VertexDeclarationHelperTest.TestVertex> PrimitiveBatch {
...
//	  private PrimitiveBatch<VertexDeclarationHelperTest.TestVertex> primitiveBatch;
...
//			new VertexDeclarationHelperTest.TestVertex[10], PrimitiveType.LineList, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[10], PrimitiveType.LineStrip, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[9], PrimitiveType.TriangleList, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[10], PrimitiveType.TriangleStrip, dummy
//		  );
//		}
//		finally {
//		  creator.PrimitiveBatch.End();
...
//		try {
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[10], createIndices(10), PrimitiveType.LineList, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[10], createIndices(10), PrimitiveType.LineStrip, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[9], createIndices(9), PrimitiveType.TriangleList, dummy
//		  );
//		  creator.PrimitiveBatch.Draw(
//			new VertexDeclarationHelperTest.TestVertex[10], createIndices(10), PrimitiveType.TriangleStrip, dummy
//		  );
//		}
//		finally {
//		  creator.PrimitiveBatch.End();
