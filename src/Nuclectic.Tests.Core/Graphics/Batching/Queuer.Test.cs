...
//	protected class DummyBatchDrawer : IBatchDrawer<VertexDeclarationHelperTest.TestVertex> {

//	  /// <summary>Initializes as new instance of the vertex drawer</summary>
//	  public DummyBatchDrawer() {
//		this.drawnBatches = new List<List<VertexDeclarationHelperTest.TestVertex>>();
//	  }
...
//	  public void Select(
//		VertexDeclarationHelperTest.TestVertex[] vertices, int vertexCount,
...
//	  /// <param name="vertices">Primitive vertices</param>
//	  /// <param name="vertexCount">Number of vertices to draw</param>
//	  public void Select(VertexDeclarationHelperTest.TestVertex[] vertices, int vertexCount) {
//		this.vertices = vertices;
//	  }
...
//		PrimitiveType type, DrawContext context
//	  ) {
//		var drawnVertices = new List<VertexPositionColor>(vertexCount);
...
//	  public List<List<VertexDeclarationHelperTest.TestVertex>> DrawnBatches {
//		get { return this.drawnBatches; }
//	  }

//	  /// <summary>Vertices currently selected for drawing</summary>
//	  private VertexDeclarationHelperTest.TestVertex[] vertices;
...
//	  private List<List<VertexDeclarationHelperTest.TestVertex>> drawnBatches;
...
//	private class DummyQueuer : Queuer<VertexDeclarationHelperTest.TestVertex> {
...
//		VertexDeclarationHelperTest.TestVertex[] vertices, int startVertex, int vertexCount,
...
//	  TestVertices = new VertexDeclarationHelperTest.TestVertex[TestVertexCount];
//	  TestIndices = new short[TestVertexCount];

//	  for(int index = 0; index < TestVertexCount; ++index) {
//		TestVertices[index] = new VertexDeclarationHelperTest.TestVertex(
...
//	protected static readonly VertexDeclarationHelperTest.TestVertex[] TestVertices;
