...
namespace Nuclectic.Tests.Graphics.Debugging
{
		...
		: TestFixtureBase
	{
		...
		public void Setup()
		{
			...
			var contentManager = mockedGraphicsDeviceService.CreateResourceContentManager(Resources.UnitTestResources.ResourceManager);
			var fillEffect = contentManager.Load<Effect>("SolidColorEffect");
			var spriteFont = contentManager.Load<SpriteFont>("LucidaSpriteFont");
			this.debugDrawer = new DebugDrawer(this.mockedGraphicsDeviceService, fillEffect, spriteFont);
		}
