...
namespace Nuclectic.Tests.Game.States
{
	...
	public class ManualGameStateManagerTest
	{
		...
		private class TestGameState : DrawableGameState, IDisposable
		{
			...
			/// <param name="gameTime">Provides a snapshot of timing values</param>
			public override void Draw(GameTime gameTime) { ++this.DrawCallCount; }
		...
		private class UnenterableGameState : GameState
		{
			...
			/// <summary>Called when the game state has been entered</summary>
			protected override void OnEntered() { throw new InvalidOperationException("Simulated error for unit testing"); }
		}
		...
		private class ReentrantGameState : GameState
		{
			...
			/// <summary>Called when the game state has been entered</summary>
			protected override void OnEntered() { this.gameStateService.Push(new TestGameState()); }
