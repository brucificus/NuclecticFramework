...
namespace Nuclectic.Tests.Graphics.SpecialEffects
{
		...
		: TestFixtureBase
	{
		...
		{
			using (var mockGraphicsDeviceService = PrepareGlobalExclusiveMockedGraphicsDeviceService())
		...
		public void TestSelect()
		{
			...
			using (IDisposable keeper = mockGraphicsDeviceService.CreateDevice())
			{
					...
					)
				{
					...
					Assert.Inconclusive("MonoGame's GraphicsDevice.GetVertexBufers() is missing");
					//Assert.AreSame(
					//  test.VertexBuffer,
