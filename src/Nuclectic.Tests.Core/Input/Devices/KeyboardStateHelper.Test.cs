...
namespace Nuclectic.Tests.Input.Devices
{
	...
	internal class KeyboardStateHelperTest
	{
		...
		public void TestAddPressedKey()
		{
			...
			KeyboardStateHelper.AddPressedKey(ref state, Keys.A);
			KeyboardStateHelper.AddPressedKey(ref state, Keys.C);
		...
		public void TestRemovedPressedKey()
		{
			...
			KeyboardStateHelper.RemovePressedKey(ref state, Keys.A);
			KeyboardStateHelper.RemovePressedKey(ref state, Keys.C);
