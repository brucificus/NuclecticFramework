...
namespace Nuclectic.Tests.Geometry
{
	...
	public static class GeoAssertHelper
	{
		...
		public static void AreAlmostEqual(Vector3 expected, Vector3 actual, int deltaUlps) { AreAlmostEqual(expected, actual, deltaUlps, null); }
		...
		/// <param name="deltaUlps">Allowed deviation in representable floating point values</param>
		public static void AreAlmostEqual(
			AxisAlignedBox3 expected, AxisAlignedBox3 actual, int deltaUlps
		...
		public static void AreAlmostEqual(
			AxisAlignedBox3 expected, AxisAlignedBox3 actual,
