...
namespace Nuclectic.Tests
{
	...
	public class TestFixtureBase
	{
		...
		/// </summary>
		protected AutoMockWrapper CreateAutoMock() { return AutoMockWrapper.CreateStrict(); }

		/// <summary>
		///     Creates a loose AutoMock context
		/// </summary>
		protected AutoMockWrapper CreateAutoMockLoose() { return AutoMockWrapper.CreateLoose(); }
