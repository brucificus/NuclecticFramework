...
namespace Nuclectic.Geometry.Lines
{
	...
	public class Segment2 : ILine2
	{
		...
		public static bool operator !=(Segment2 first, Segment2 second) { return !(first == second); }
		...
		public override bool Equals(object other) { return Equals(other as Segment2); }
