...
namespace Nuclectic.Geometry.Lines
{
	...
	public class Line2 : ILine2
	{
		...
		public Line2(Line2 other)
			: this(other.Offset, other.Direction) { }
		...
		public static bool operator !=(Line2 first, Line2 second) { return !(first == second); }
		...
		public override bool Equals(object other) { return Equals(other as Line2); }
