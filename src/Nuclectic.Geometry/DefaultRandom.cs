...
namespace Nuclectic.Geometry
{
	...
	public class DefaultRandom : IRandom
	{
		...
		/// </summary>
		public DefaultRandom() { this.random = new Random(); }
		...
		///     value is calculated
		/// </exception>
		public DefaultRandom(int seed) { this.random = new Random(seed); }
		...
		/// </exception>
		public int Next(int maximumValue) { return this.random.Next(maximumValue); }
		...
		///     and less than 1.0
		/// </returns>
		public double NextDouble() { return this.random.NextDouble(); }
