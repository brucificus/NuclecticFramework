...
namespace Nuclectic.Geometry.Areas
{
	...
	public class Rectangle2 : IArea2
	{
		...
		public float Area { get { throw new Exception("The method or operation is not implemented."); } }

		/// <summary>The total length of the area's circumference</summary>
		public float CircumferenceLength { get { return (Width * 2.0f) + (Height * 2.0f); } }

		/// <summary>The center of mass within the shape</summary>
		public Vector2 CenterOfMass { get { throw new Exception("The method or operation is not implemented."); } }

		/// <summary>Smallest rectangle that encloses the shape in its entirety</summary>
		public AxisAlignedRectangle2 BoundingBox { get { throw new Exception("The method or operation is not implemented."); } }
		...
		public Vector2 ClosestPointTo(Vector2 location) { throw new Exception("The method or operation is not implemented."); }
