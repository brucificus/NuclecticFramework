...
// Nuclectic Framework  Copyright (C) 2014 Nuclectic Contributors
// Nuclex Framework  Copyright (C) 2002-20012 Nuclex Development Labs
// 
...
// 
// You should have received a copy of the IBM Common Public License along with this library.
