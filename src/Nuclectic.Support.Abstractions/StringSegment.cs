...
namespace Nuclectic.Support
{
	...
	public struct StringSegment
	{
		...
		public StringSegment(string text)
		{
			if (text == null)
			{
				// questionable, but matches behavior of ArraySegment class
		...
		public override int GetHashCode() { return this.text.GetHashCode() ^ this.offset ^ this.count; }
		...
		///   equality operator
		/// </param>
		public static bool operator ==(StringSegment left, StringSegment right) { return left.Equals(right); }
		...
		///   inequality operator
		/// </param>
		public static bool operator !=(StringSegment left, StringSegment right) { return !(left == right); }
		...
		public override string ToString() { return this.text.Substring(this.offset, this.count); }
