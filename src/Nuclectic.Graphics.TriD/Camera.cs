...
namespace Nuclectic.Graphics.TriD
{
	...
	public class Camera : ICamera
	{
		...
		public Vector3 Position { get { return Matrix.Invert(this.View).Translation; } set { MoveTo(value); } }

		/// <summary>The camera's forward vector</summary>
		public Vector3 Forward { get { return Matrix.Invert(this.View).Forward; } }

		/// <summary>The camera's right vector</summary>
		public Vector3 Right { get { return Matrix.Invert(this.View).Right; } }

		/// <summary>The camera's up vector</summary>
		public Vector3 Up { get { return Matrix.Invert(this.View).Up; } }

		Matrix ICamera.View { get { return View; } }

		Matrix ICamera.Projection { get { return Projection; } }
