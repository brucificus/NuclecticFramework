...
namespace Nuclectic.Graphics.TriD.Batching
{
	...
	public class BasicEffectDrawContext : EffectDrawContext, IDisposable
	{
		...
		public BasicEffectDrawContext(GraphicsDevice graphicsDevice)
			:
				base(createEffect(graphicsDevice)) { this.basicEffect = base.effect as BasicEffect; }
		...
		/// <param name="graphicsDevice">GraphicsDevice the effect will use</param>
		private static BasicEffect createEffect(GraphicsDevice graphicsDevice) { return new BasicEffect(graphicsDevice); }
